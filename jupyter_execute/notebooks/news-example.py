...
# For DLRM model, lets consider this [sample config](https://github.com/NVIDIA/HugeCTR/blob/master/samples/dlrm/dlrm_fp32_64k.json) which is available on HugeCTR's github repository, and modify it for our dataset.
# 
