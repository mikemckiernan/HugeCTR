...
void FullyConnectedLayerHalf::fprop(bool is_train) {
  ...
  PROFILE_RECORD("fully_connected_layer_half.fprop.start", get_gpu().get_stream(), get_device_id());
  ...
  PROFILE_RECORD("fully_connected_layer_half.fprop.cublasGemmEx_1.start", get_gpu().get_stream(), get_device_id());
  ...
  PROFILE_RECORD("fully_connected_layer_half.fprop.cublasGemmEx_1.stop", get_gpu().get_stream(), get_device_id());

  PROFILE_RECORD("fully_connected_layer_half.fprop.cublasGemmEx_2.start", get_gpu().get_stream(), get_device_id());
  ...
  PROFILE_RECORD("fully_connected_layer_half.fprop.cublasGemmEx_2.stop", get_gpu().get_stream(), get_device_id());
...
void FullyConnectedLayerHalf::bprop() {
  ...
  PROFILE_RECORD("fully_connected_layer_half.bprop.cublasGemmEx_1.start", get_gpu().get_stream(), get_device_id());
  ...
  PROFILE_RECORD("fully_connected_layer_half.bprop.cublasGemmEx_1.stop", get_gpu().get_stream(), get_device_id());

  PROFILE_RECORD("fully_connected_layer_half.bprop.cublasGemmEx_2.start", get_gpu().get_stream(), get_device_id());
  ...
  PROFILE_RECORD("fully_connected_layer_half.bprop.cublasGemmEx_2.stop", get_gpu().get_stream(), get_device_id());

  PROFILE_RECORD("fully_connected_layer_half.bprop.cublasGemmEx_3.start", get_gpu().get_stream(), get_device_id());
  ...
  PROFILE_RECORD("fully_connected_layer_half.bprop.cublasGemmEx_3.stop", get_gpu().get_stream(), get_device_id());

  PROFILE_RECORD("fully_connected_layer_half.bprop.stop", get_gpu().get_stream(), get_device_id());
